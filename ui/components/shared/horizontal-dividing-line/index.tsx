...
export default function HorizontalDividingLine() {
  ...
  return (
    <div className="relative flex w-full items-center justify-center">
      <hr className="absolute left-0 w-[45%] border-clear-sky-indicator border-dashed dark:border-accent-foreground" />
      <motion.div
        style={{ rotate }}
        drag="x"
        dragDirectionLock
      ...
      >
        <FlowerIcon className="text-clear-sky-indicator dark:text-accent-foreground" />
      </motion.div>
      <hr className="absolute right-0 w-[45%] border-clear-sky-indicator border-dashed dark:border-accent-foreground" />
    </div>
  )
}
